...
class PlutonRouter {
  ...
  options(_path, _options, _handler) {
    this.on(http2.constants.HTTP2_METHOD_OPTIONS, _path, _options, _handler);
  }

  get(_path, _options, _handler) {
    this.on(http2.constants.HTTP2_METHOD_GET, _path, _options, _handler);
  }

  post(_path, _options, _handler) {
    this.on(http2.constants.HTTP2_METHOD_POST, _path, _options, _handler);
  }

  put(_path, _options, _handler) {
    this.on(http2.constants.HTTP2_METHOD_PUT, _path, _options, _handler);
  }

  delete(_path, _options, _handler) {
    this.on(http2.constants.HTTP2_METHOD_DELETE, _path, _options, _handler);
  }
